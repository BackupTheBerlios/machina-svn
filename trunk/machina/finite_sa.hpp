#ifndef   MACHINA_FINITE_SA_HPP
#define   MACHINA_FINITE_SA_HPP
...
template < class InT    = std::string
         , class WtT    = double
         , class AllocT = std::allocator< InT >
         >
class finite_sa {
    struct state_info;
    class  trans_info;
...
private:
    ...
    public:
        ...
        input_type  const& input()  const {return m_tok;}
